...
public interface CL_GameRoom
{
	 ...
	 */
	public void onLogin(CL_PlayerSession playerSession);
	 ...
	 *            a {@link Channel} object wrapped in a {@link CL_PlayerSession}.
	 * @return true if session is connected successfully.
	 */
	public abstract boolean connectSession(CL_PlayerSession playerSession);
	 ...
	 */
	public abstract boolean disconnectSession(CL_PlayerSession session);
	 ...
	 */
	public abstract Set<CL_PlayerSession> getSessions();
	 ...
	 */
	public abstract void setSessions(Set<CL_PlayerSession> sessions);
	 ...
	 * etc and then send it across to other {@link CL_PlayerSession}s if required.
